      ...
      if (showUrlDialog) {
        StreamUrlDialog(
          ...
          onCopy = {
            ...
            val clip = android.content.ClipData.newPlainText("流媒体URL", urlDialogContent)
            clipboardManager.setPrimaryClip(clip)
            android.widget.Toast.makeText(context, "URL已复制到剪贴板", android.widget.Toast.LENGTH_SHORT).show()
          }
        )
      }
    }
